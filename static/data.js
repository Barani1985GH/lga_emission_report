...
let optionchange = 0;
let search_sector = 'Agriculture'

// code to find emission amount for selected LGA & year
...
d3.json("get_by_lga_year/"+search_lga+"/"+search_year).then(function(data) {
   ...
   d3.select("#chart2").text(search_lga + " in "+search_year)
